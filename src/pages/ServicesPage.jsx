        ...
        <div className="min-h-screen bg-[#FDF7FF]">
            ...
            <main className="max-w-7xl mx-auto px-4 py-16 md:py-24">
                <div className="text-center mb-16 px-4">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold text-[#1C1B1F] mb-6 tracking-tight">Services d'Excellence</h1>
                    <p className="text-[#49454E] max-w-2xl mx-auto text-lg md:text-xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map((s, i) => (
                        <div
                            key={i}
                            className="group bg-white rounded-[2rem] overflow-hidden border border-[#CAC4D0] shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col"
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <Link
                                    to="/contact"
                                    className="mt-6 w-full py-2.5 text-center rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors shadow-sm"
                                >
                                    Contactez-nous
                                </Link>
                            </div>
