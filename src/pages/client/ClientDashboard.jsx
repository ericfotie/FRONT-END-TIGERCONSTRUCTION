        ...
        <div className="min-h-screen bg-[#FDF7FF] flex flex-col font-sans">
            ...
            <div className="relative w-full h-[30vh] md:h-[40vh] bg-[#6750A4] overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                    <h1 className="text-3xl md:text-6xl font-extrabold text-white mb-4 tracking-tight">Votre espace client</h1>
                    <p className="text-lg md:text-xl text-[#EADDFF] font-medium px-4">Suivi en temps réel de vos chantiers TIGER CONSTRUCTION.</p>
                </div>
            </div>
